...
/**
 * The playbill waitlist landing. Rendered at `/` on a self-hosted install (the maker's
 * own waitlist) and at `/demo` on refqueue.com (the live sample). Data is read/provisioned
 * per request; callers set `export const dynamic = 'force-dynamic'`.
 */
export async function WaitlistLanding({ referralCode, verifyFailed }: Props) {
